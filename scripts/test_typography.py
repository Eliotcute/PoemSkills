...
def main() -> int:
    ...
    valid = latin_intact and punctuation_valid and cjk_detected
    print(json.dumps({"valid": valid, "lines": lines, "punctuation_valid": punctuation_valid, "cjk_detected": cjk_detected}, ensure_ascii=False, indent=2))
