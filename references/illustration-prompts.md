...
```text
生成一幅单色纯黑的凸版印刷插图：主体是【中心主体】，四周由【与主题有关的植物／器物／象征元素】密集包围并与主体交错。画面像 1970 年代反主流文化邮购目录里的民间木刻或粗糙油毡版画，不是精致古典铜版画。
